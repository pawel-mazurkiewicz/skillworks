...
- Name: visual/baseline.spec.js >> baseline:manage-selected
...
Call log:
  - waiting for locator('#matrixBody .skill-list-button').first()
    - locator resolved to <button type="button" class="skill-list-button">…</button>
